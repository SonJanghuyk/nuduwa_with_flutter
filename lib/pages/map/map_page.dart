...
class MapPage extends GetView<MapPageController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(() {
        ...
        final markers = controller.meetingsAndMarkers.values
  ...
  Align seletedLocationButton(BuildContext context) {
    return Align(
      alignment:
          Alignment(Alignment.bottomCenter.x + 0.11, Alignment.bottomCenter.y),
      child: SizedBox(
        width: 150,
        height: 40,
  ...
  Align filterButton() {
    return Align(
      alignment: Alignment(Alignment.topLeft.x, Alignment.topLeft.y + 0.1),
      child: Obx(
        () => IntrinsicWidth(
          child: Container(
            height: 50,
